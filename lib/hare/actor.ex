defmodule Hare.Actor do
  ...
  def start_link(given_layers, conn, initial, opts \\ []) do
  ...
  defdelegate call(server, message),          to: Connection
  defdelegate call(server, message, timeout), to: Connection
  defdelegate cast(server, message),          to: Connection
